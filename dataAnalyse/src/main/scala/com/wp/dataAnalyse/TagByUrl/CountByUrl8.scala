...
import com.zb.ac.AC2Util4
import scala.collection.Seq
import collection.JavaConverters._
import org.apache.spark.broadcast.Broadcast
import com.zb.ac.ACtest

object CountByUrl8 extends Serializable{
//  new AC2Util("G:/tmp/jptest/tag_conf.txt", ",")
//  var tag_list:Broadcast[List[String]]  = _
//  private val ac1:Broadcast[AC2Util3]  = _
...
//      val x = line.split("\t")
/*      var list2= tag_list.value.asJava 
//     var list1: java.util.List[String] = seq_data.asJava
     AC2Util3.list1 = list2
     new AC2Util3();*/
//      var ac2 = ac1.value
      println("tag_list.value(0)---------"+tag_list.value(0))
      println(ac1.value)
...
//        val tags =  ac.getTag2(url).replace(",", "|")
         val tags =  ac1.value.getTag2(url).replace(",", "|")
//        val tags = "001"
